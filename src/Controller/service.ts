...
// get Service By Id
export const getServiceById = async (req: ServiceRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
...
//Add New Service
export const addNewService = async (req: ServiceRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    let obj = new Service({
      logo: (req.files as any)?.logo ? (req.files as any).logo[0]?.filename : '',
      title: {
...
export const updateService = async (req: ServiceRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    let data = await Service.findOneAndUpdate({ _id: req.body.serviceId }, {
      logo: (req.files as any)?.logo?.[0] ? (req.files as any).logo?.[0].filename : req.body.logo ? req.body.logo : '',
      title: {
        ar: req.body.title_ar,
        en: req.body.title_en,
      },
...
//Delete Service
export const deleteService = async (req: ServiceRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
    if (!req.isAdmin) throw new Error("Not Allowed");
...
export const deleteQuestion = async (req: ServiceRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
    if (!req.isAdmin) throw new Error("Not Allowed");
...
export const updateQuestion = async (req: ServiceRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
    if (!req.isAdmin) throw new Error("Not Allowed");
...
export const addQuestion = async (req: ServiceRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
    if (!req.isAdmin) throw new Error("Not Allowed");
...
export const getServiceQuestions = async (req: ServiceRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
    if (!req.isAdmin) throw new Error("Not Allowed");
